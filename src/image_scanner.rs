...
impl ImageScanner {
    ...
    pub fn recycle_image(&mut self, image: &mut Image) {
    ...
    pub fn scan_image(&mut self, image: &mut Image) -> ZBarResult<SymbolSet> {
...
mod test {
    ...
    #[test]
    fn test_code128() {
        let mut image = Image::from_path("test/code128.gif").unwrap();
